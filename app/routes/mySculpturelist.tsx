...
export default function EProject() {
    ...
    return (
        <center>
        <div className="p-10 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url('./images/bg2.gif')`}}>
        <button className=" bg-red-500 rounded-3xl" onClick={handleClickBack} >
                Prev 
            </button>
